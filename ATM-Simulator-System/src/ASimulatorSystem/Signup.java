...
public class Signup extends JFrame implements ActionListener {
    ...
    JTextField t1, t2, t3, t4, t5, t6, t7, t8, t9, t10; // Added fields for date (day, month, year)
    ...
    Signup() {
        ...
        t6 = new JTextField(); // For email
        t6.setFont(new Font("Raleway", Font.BOLD, 14));
        
        t7 = new JTextField(); // For address
        t7.setFont(new Font("Raleway", Font.BOLD, 14));
        
        t8 = new JTextField(); // For city
        t8.setFont(new Font("Raleway", Font.BOLD, 14));
        
        t9 = new JTextField(); // For pincode
        t9.setFont(new Font("Raleway", Font.BOLD, 14));
        
        t10 = new JTextField(); // For state
        ...
        t4.setBounds(360, 240, 50, 30);
        add(t4);
        
        t5.setBounds(420, 240, 80, 30);
        add(t5);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        // Combine date fields
        String dob = t3.getText() + "/" + t4.getText() + "/" + t5.getText();
